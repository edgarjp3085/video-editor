...
```
┌─────────────────────────────────────────────┐
│  🎬 Editor de Vídeo para Kwai               │
├─────────────────────────────────────────────┤
│ ⚙️ Configurações │ 🎥 Processar │ 📋 Log     │
├─────────────────────────────────────────────┤
│  🔑 Google API Key: [************]          │
│  📁 Pasta Entrada: [videos_originais] [📂]  │
│  📁 Pasta Saída:   [videos_editados]  [📂]  │
│  🎯 Título: [Deixe vazio para IA]          │
│  📍 Posição: ● Superior ○ Inferior          │
│  ✅ Anti-plágio ✅ Desligar após concluir   │
└─────────────────────────────────────────────┘
```
